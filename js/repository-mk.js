        ...
        data.forEach(function(anim) {
            ...
            firebase.storage().ref("animFiles").child(anim.name + ".anim").getDownloadURL().then(function(animDownloadUrl) {
                firebase.storage().ref("mp4Files").child(anim.name + ".mp4").getDownloadURL().then(function(downloadUrl) {
                    blocks += '<div class="box box' + k + ' fadeInUp clust" style="min-height:10px;background:#412A58;float:left;margin-bottom:2px;">';
                    ...
                    blocks += '<a data-url="' + animDownloadUrl + '" data-name="' + anim.name + '.anim" download href="'+animDownloadUrl+'" style="float:none !important;text-align:center;display:block;margin-top:8px"><i class="fa fa-download fa-2x" aria-hidden="true"></i></a>';
                    blocks += '<a class="newwwww" href="javascript:;" data-name="' + anim.name + '" ><i class="fa fa-plus-circle fa-2x" aria-hidden="true" style="position:absolute;top:7px;right:7px;"></i></a>';
                    blocks += '</div>';
					blocks += '<a class="newwwww" href="javascript:;" data-name="' + anim.name + '" ><i class="fa fa-plus-circle fa-2x" aria-hidden="true" style="position:absolute;top:7px;right:7px;"></i></a>';
